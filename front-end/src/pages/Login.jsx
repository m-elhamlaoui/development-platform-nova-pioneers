  ...
  return (
    ...
    <div className="w-4xl rounded-2xl border border-gray-400 bg-[url('./assets/astronaut.png')] bg-no-repeat bg-right">
      ...
      <div className="bg-white h-[70vh]  flex flex-col items-center justify-center shadow-xl  rounded-2xl border-2 border-gray-300 w-lg">
        <h1 className='text-4xl text-blue-900 font-bold text-center '>WELCOME BACK</h1>
        <h2 className="font-light text-sm text-center flex justify-center  text-black mt-100 ">Welcome Back! Please enter your details</h2>
...
<form class=" flex flex-col items-center " acion="">
  ...
  <div >
    ...
    <input type="email" id="email" className=" border border-gray-200 w-full rounded-lg py-2 px-4 bg-gray-100" placeholder="Enter your email" required />
  </div>
  <div class="mb-5">
  ...
  <div class="flex justify-center items-center ">
        <div class="  w-1/2 ">
            <input id="remember_me" name="remember" type="checkbox" value="1" class="form-checkbox transition duration-150 ease-in-out" />
    ...
    <div class=" flex whitespace-nowrap  h-8 w-1/2  ">
        ...
        <div>
          <button className="bg-red-500 hover:bg-blue-700 text-white font-bold py-2  w-xs px-4 rounded-2xl">Log in</button>
          </div>
